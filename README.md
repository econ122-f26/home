...
**Wednesday** (exploratory data analysis (EDA))
  ...
  -   discuss Team Project 1 — [read the prompt and data](https://github.com/econ122-templates/tp1-template){:target="_blank"} (no sign-up needed). Teams of up to 4: when you're ready, one person [accepts](https://classroom50.org/econ122-f26/econ122-f26/assignments/tp1/accept) and creates the group; teammates then either ask to join it there or get added by GitHub username. Report due 09/25, team defenses in class 09/28
...
**Monday** (Team Project 1 team defenses)
  -   in class: team defenses (~5 min per team); remaining time for debrief and

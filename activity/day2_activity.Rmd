...
### Part 1: Get Your Assignment Repo (5 mins)

Before you can edit anything, you need your own copy of this activity through Classroom 50.

#### Step 1: Join the Class Organization (one-time)

If you haven't already:

1. Accept the email invite to the **econ122-f26** GitHub organization.
2. Go to **classroom50.org**, sign in with GitHub, and confirm you see **econ122-f26** listed.

You only need to do this once, at the start of the semester.

#### Step 2: Accept This Assignment

Click the assignment link: **TBD** *(posted separately — check the README)*. Confirm to accept. This creates a private repository just for you, with this activity file (`day2_activity.Rmd`) already inside it.

#### Step 3: Clone Your Assignment Repo into RStudio

1. On your new repo's GitHub page, click the green **"Code"** button and copy the HTTPS URL.
2. In RStudio, go to `File > New Project...`, select **"Version Control"** then **"Git"**, and paste the URL into the **"Repository URL"** field.
3. Choose a project directory and click **"Create Project"**.

RStudio will download your repo, and you should see `day2_activity.Rmd` — this exact file — in the Files pane. **Open it and keep working from your own copy for the rest of this activity**, not wherever you're reading this from now.

### Part 2: Creating a Reproducible Report with R Markdown (20 mins)

In this section, you will build out a simple R Markdown report that combines text and code, working directly in your own `day2_activity.Rmd`.
...
### Part 3: Commit and Push (Submit Your Work) (15 mins)

In this section, you'll use Git to save your changes and push them to GitHub — this is what actually submits your work.

#### Step 1: Commit Your Changes

In the **"Git"** pane in RStudio, you should see `day2_activity.Rmd` (and its knitted `.md`/`.html` output) listed once you've saved.

1.  Stage the files: Click the "Staged" checkbox next to **both** your `.Rmd` and its knitted output file.
...
Click the green "Push" (up arrow) button in the Git pane to send your changes to GitHub — this is what makes your work visible to me for grading.
